...
import type { VModelType, RModelType } from '~/components/message/Confirm.vue';

export const useMessageConfirmStore = defineStore('messageConfirmStore', () => {
  ...
  function open(aTitle: string, message: string, isPersistent: boolean, onClose?: (abConfirmed: boolean) => void) {
